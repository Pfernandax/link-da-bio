...
const INITIAL: PageConfig = {
  ...
  categories:[
    { id: crypto.randomUUID(), title:"Destaques", limit:6, items:[
...
export default function EditorLinkBio() {
  ...
  // ---- Funções para GERAR o link público ----
  const encodePage = (p: PageConfig) => {
    const json = JSON.stringify(p);
    const b64 = btoa(String.fromCharCode(...new TextEncoder().encode(json))); // unicode-safe
